        ...
        <div class=" container">
            ...
            <div class="d-none d-md-block bg-ink py-2 text-center text-white small tracking-wide"
                ...
                Free delivery over €45.00 · Kitchen open until 01:00 Fri &amp; Sat · <a href="tel:+351214470180"
                    class="text-white text-decoration-underline" style="text-underline-offset: 4px;">+351 21 447
                    0180</a>
            </div>
                        ...
                        <div class="collapse navbar-collapse " id="navbarContent" style="">
                            ...
                            <div class="d-block d-lg-none px-3 pb-4 pt-2">
                                <ul class="navbar-nav w-100 my-2">
                                    <li class="nav-item border-bottom py-3" style="border-color: #f3efe6;"><a
                                            class="nav-link active p-0 fw-semibold" href="#"
                                            style="color: #c17015; font-size: 1.1rem;">Home</a></li>
                                    <li class="nav-item border-bottom py-3" style="border-color: #f3efe6;"><a
                                            class="nav-link p-0" href="#"
                                            style="color: #211813; font-size: 1.1rem;">Menu</a></li>
                                    <li class="nav-item border-bottom py-3" style="border-color: #f3efe6;"><a
                                            class="nav-link p-0" href="#"
                                            style="color: #211813; font-size: 1.1rem;">Reservations</a></li>
                                    <li class="nav-item border-bottom py-3" style="border-color: #f3efe6;"><a
                                            class="nav-link p-0" href="#"
                                            style="color: #211813; font-size: 1.1rem;">Offers</a></li>
                                    <li class="nav-item border-bottom py-3" style="border-color: #f3efe6;"><a
                                            class="nav-link p-0" href="#"
                                            style="color: #211813; font-size: 1.1rem;">About</a></li>
                                    <li class="nav-item py-3" style="border-bottom: none;"><a class="nav-link p-0"
                                            href="#" style="color: #211813; font-size: 1.1rem;">Contact</a></li>
                                </ul>
                ...
                <div class="container">
                    <div class="row g-5">
                        ...
                        <div class="col-lg-2 col-md-6">
                            <h6 class="text-uppercase small text-white-50 fw-semibold"
                        ...
                        <div class="col-lg-3 col-md-6">
                            <h6 class="text-uppercase small text-white-50 fw-semibold"
                                style="letter-spacing: 0.15em;">
                                Newsletter</h6>
                            <p class="mt-4 small text-white-50">Seasonal menus, chef's table invitations, nothing else.
                            </p>
