        ...
        <div class="container-page py-4">
            ...
            <div class="row g-5 mt-3">
                ...
                <div class="col-lg-7">
                    ...
                    <!-- Map Placeholder -->
                    <div class="d-flex align-items-center justify-content-center bg-secondary bg-opacity-10 border border-border rounded-5 text-muted small"
                        style="height: 288px;">
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 g-3 mt-4">
                        <div class="col">
                            <a href="tel:+351 21 447 0180"
                                class="text-decoration-none d-block hover-lift border border-border bg-white rounded-5 p-4 shadow-soft">
                    ...
                    <!-- Opening Hours -->
                    <div class="mt-4 border border-border bg-white rounded-5 p-4 shadow-soft">
                        ...
                        <dl class="row mt-3 small mb-0">
                            <div class="col-12 d-flex justify-content-between  pb-2 mb-2">
                                <dt class="text-muted col-6">Monday – Thursday</dt>
                                <dd class="fw-semibold tabular-nums col-6 text-end">12:00 – 23:00</dd>
                            </div>
                            <div class="col-12 d-flex justify-content-between  pb-2 mb-2">
                                <dt class="text-muted col-6">Friday – Saturday</dt>
                                <dd class="fw-semibold tabular-nums col-6 text-end">12:00 – 01:00</dd>
                            </div>
                            <div class="col-12 d-flex justify-content-between pb-2">
                                <dt class="text-muted col-6">Sunday</dt>
                                <dd class="fw-semibold tabular-nums col-6 text-end">12:00 – 22:00</dd>
                            </div>
                        </dl>
                    </div>
                </div>
                ...
                <div class="col-lg-5">
                    ...
                    <!-- Contact Form -->
                    <form class="border border-border bg-white rounded-5 p-4 p-md-5 shadow-soft">
                        ...
                        <div class="mt-3 d-flex flex-column gap-3">
                            <div>
                                ...
                                <input id="cname" required type="text"
                                    class="form-control menu-search rounded-5 mt-1 min-h-13">
                            </div>
                            <div>
                            ...
                            <div>
                                <label for="csubject"
                                    class="small text-uppercase fw-semibold text-muted">Subject</label>
                                <input id="csubject" required type="text"
                                    class="form-control menu-search rounded-5 mt-1 min-h-13">
                            </div>
                            <div>
                                <label for="cmsg"
                                    class="small text-uppercase fw-semibold text-muted">Message</label>
                                <textarea id="cmsg" rows="5" required class="form-control menu-search rounded-5 mt-1 p-3"></textarea>
                            </div>
                        </div>

                        <button type="submit" class="btn btn-primary w-100 rounded-pill py-3 fw-semibold mt-4">Send
                            message</button>
                    </form>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="mt-3 d-flex flex-column gap-3">
                            <details class="border border-border rounded-5 p-3 bg-white">
                                <summary class="cursor-pointer fw-semibold small">Do you take walk-ins?</summary>
                                <p class="mt-2 small text-muted mb-0">Always. We hold four tables back each service for
                                    guests who just turn up.</p>
                            </details>
                            <details class="border border-border rounded-5 p-3 bg-white">
                                <summary class="cursor-pointer fw-semibold small">How far do you deliver?</summary>
                                <p class="mt-2 small text-muted mb-0">Six kilometres from the kitchen, covering central
                                    Lisbon and Alcântara.</p>
                            </details>
                            <details class="border border-border rounded-5 p-3 bg-white">
                                <summary class="cursor-pointer fw-semibold small">Can you handle allergies?</summary>
                                <p class="mt-2 small text-muted mb-0">Yes. Add a note at checkout or tell us at the
                                    table — the kitchen sees it on the ticket.</p>
                            </details>
                            <details class="border border-border rounded-5 p-3 bg-white">
