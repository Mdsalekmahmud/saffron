...
<head>
    ...
    <!-- 🔥 ক্যাশ ক্লিয়ার করার জন্য ভেরিয়েবল যুক্ত করা হয়েছে -->
    ...
    <style>
        ...
        .heart-btn { transition: transform 0.3s; }
        ...
        .text-ink-foreground { color: #ffffff; }
        .text-ink-foreground\/75 { color: rgba(255, 255, 255, 0.75); }
        .text-ink-foreground\/55 { color: rgba(255, 255, 255, 0.55); }
        .text-ink-foreground\/65 { color: rgba(255, 255, 255, 0.65); }

        .star-fill { color: var(--brand-gold) !important; }
        ...
        .card-text-hover:hover { color: #d36419 !important; }
...
<body>
    ...
    <div class="d-flex flex-column min-vh-100" style="background-color:#ffffff;">
            ...
            <nav class="navbar navbar-expand-lg px-3 px-lg-0">
                <div class="container-fluid container-lg d-flex align-items-center justify-content-between">
                    ...
                    <div class="d-flex d-lg-none align-items-center gap-2">
                        ...
                        <a href="#" class="primary-button-hover d-flex align-items-center justify-content-center text-dark text-decoration-none rounded-circle"
                            style="background-color: #f6efe3; width: 40px; height: 40px;">
                            <i class="bi bi-bag fs-5"></i>
                        </a>
                        <button class="navbar-toggler border-0 d-flex d-lg-none align-items-center justify-content-center text-dark rounded-circle p-0"
                    ...
                    <div class="collapse navbar-collapse" id="navbarContent" style="">
                        ...
                        <!-- 🔥 2. মোবাইলের মেনু (শুধু মোবাইলে ওপেন হবে Image 3) -->
                        <div class="d-block d-lg-none px-3 pb-4 pt-2">
                            <ul class="navbar-nav w-100 my-2">
                                <li class="nav-item border-bottom py-3" style="border-color: #f3efe6;"><a class="nav-link active p-0 fw-semibold" href="#" style="color: #c17015; font-size: 1.1rem;">Home</a></li>
                                <li class="nav-item border-bottom py-3" style="border-color: #f3efe6;"><a class="nav-link p-0" href="#" style="color: #211813; font-size: 1.1rem;">Menu</a></li>
                                <li class="nav-item border-bottom py-3" style="border-color: #f3efe6;"><a class="nav-link p-0" href="#" style="color: #211813; font-size: 1.1rem;">Reservations</a></li>
                                <li class="nav-item border-bottom py-3" style="border-color: #f3efe6;"><a class="nav-link p-0" href="#" style="color: #211813; font-size: 1.1rem;">Offers</a></li>
                                <li class="nav-item border-bottom py-3" style="border-color: #f3efe6;"><a class="nav-link p-0" href="#" style="color: #211813; font-size: 1.1rem;">About</a></li>
                                <li class="nav-item py-3" style="border-bottom: none;"><a class="nav-link p-0" href="#" style="color: #211813; font-size: 1.1rem;">Contact</a></li>
                            </ul>
                            <div class="d-flex align-items-center gap-3 mt-2">
                                <button class="btn btn-outline-light rounded-pill flex-grow-1 py-3 fw-medium"
                                    style="color: #211813; border-color: #d1cec6; font-size: 0.95rem;">Reserve a table</button>
        ...
        <!-- ========================================== -->
        <!-- 3. আপনার দেওয়া x-app (Hero, Category, ইত্যাদি) -->
        <!-- ========================================== -->
        {{ $slot }}
        ...
        <footer class="bg-ink text-white mt-auto py-5">
            <div class="container">
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        <div class="d-flex align-items-center gap-3">
                            <span class="d-flex align-items-center justify-content-center bg-primary text-white rounded-circle fw-bold"
                        ...
                        <p class="mt-4 small text-white-50 lh-lg" style="max-width: 350px;">Fire-kissed cooking, served with intention. A fire kitchen in the old town, cooking with farm partners within ninety kilometres of the door.</p>
                    ...
                    <div class="col-lg-2 col-md-6">
                        <h6 class="text-uppercase small text-white-50 fw-semibold" style="letter-spacing: 0.15em;">Explore</h6>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <h6 class="text-uppercase small text-white-50 fw-semibold" style="letter-spacing: 0.15em;">Find us</h6>
                        <ul class="list-unstyled mt-4 d-flex flex-column gap-3 text-white-50 small">
                            ...
                            <li class="d-flex gap-3">
                                ...
                                <a href="mailto:hello@saffronandember.com" class="text-white-50 text-decoration-none footer-link">hello@saffronandember.com</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <h6 class="text-uppercase small text-white-50 fw-semibold" style="letter-spacing: 0.15em;">Newsletter</h6>
                        ...
                        <div class="d-flex align-items-center gap-2 mt-3">
                            ...
                            <button class="btn btn-primary rounded-pill px-4 py-2 fw-semibold" type="submit">Join</button>
                        </div>
                        <p class="mt-4 text-uppercase small text-white-50 fw-semibold" style="letter-spacing: 0.15em;">Also on</p>
                ...
                <div class="d-flex flex-column flex-lg-row justify-content-between align-items-center gap-4 small text-white-50">
        ...
        <nav class="d-lg-none mobile-nav fixed-bottom z-3">
            <ul class="nav nav-fill">
                <li class="nav-item"><a href="#" class="nav-link d-flex flex-column align-items-center small text-primary py-2"><i class="bi bi-house fs-5"></i> <span class="small">Home</span></a></li>
                <li class="nav-item"><a href="#" class="nav-link d-flex flex-column align-items-center small text-muted py-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-utensils-crossed h-5 w-5" aria-hidden="true"><path d="m16 2-2.3 2.3a3 3 0 0 0 0 4.2l1.8 1.8a3 3 0 0 0 4.2 0L22 8"></path><path d="M15 15 3.3 3.3a4.2 4.2 0 0 0 0 6l7.3 7.3c.7.7 2 .7 2.8 0L15 15Zm0 0 7 7"></path><path d="m2.1 21.8 6.4-6.3"></path><path d="m19 5-7 7"></path></svg> <span class="small">Menu</span></a></li>
                <li class="nav-item"><a href="#" class="nav-link d-flex flex-column align-items-center small text-muted py-2"><i class="bi bi-calendar4-week fs-5"></i> <span class="small">Book</span></a></li>
                <li class="nav-item"><a href="#" class="nav-link d-flex flex-column align-items-center small text-muted py-2"><i class="bi bi-bag fs-5"></i> <span class="small">Bag</span></a></li>
                <li class="nav-item"><a href="#" class="nav-link d-flex flex-column align-items-center small text-muted py-2"><i class="bi bi-person fs-5"></i> <span class="small">Account</span></a></li>
            </ul>
        </nav>
    </div>
